                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="name" name="name" placeholder="" value="{{$payment->name}}" type="text">
                                        </div>

                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox checkbox-primary">
                                                <input class="custom-control-input" id="enabled" name="enabled" @if($payment->enabled) checked="" @endif type="checkbox">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="payment_deliveries[]" class="select2 select2-multiple" multiple="multiple" data-placeholder="Choose">
                                                @foreach($all_deliveries as $d)
                                                    <option value="{{$d->id}}" @if(in_array($d->id, $payment_deliveries)) selected @endif>{{$d->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group fn_image_div">
                                            ...
                                            @if(!empty($payment->icon))
                                                <div class="fn_image_block">
                                                    <img src="{{$payment->imageView()}}" width="160" height="120">
                                                    <BR>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="tinymce-wrap">
                                                <textarea class="tinymce" name="full_text">{{$payment->full_text}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
