                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="price" name="price" placeholder="" value="{{$product->price}}" type="text">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="old_price" name="old_price" placeholder="" value="{{$product->old_price}}" type="text">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <select name="related_products[]" class="select2 select2-multiple" multiple="multiple" data-placeholder="Choose">
                                                    @foreach($all_products as $p)
                                                        @if($p->id != $product->id)
                                                            <option value="{{$p->id}}" @if(in_array($p->id, $related_products)) selected @endif>{{$p->name}}</option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                            </div>
