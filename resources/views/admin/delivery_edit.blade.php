                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="module" class="form-control select2 fn_select_module">
                                                <option value="" @empty($delivery->module) selected @endempty>--Empty--</option>
                                                @foreach($delivery_modules as $value=>$details)
                                                    <option value="{{$value}}" @if($delivery->module==$value) selected @endif>{{$details['name']}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                @empty($setting['options'])
                                                                    ...
                                                                    <input class="form-control" id="{{$loop->iteration}}_{{$setting['field']}}" name="settings[{{$setting['field']}}]" placeholder="" value="{{$delivery->getSetting($setting['field'])}}" type="text">
                                                                @else
                                                                    <label>{{$setting['name']}}</label>
                                                                    <select name="settings[{{$setting['field']}}]" class="form-control select2">
                                                                        @foreach($setting['options'] as $option_value=>$option_name)
                                                                            <option value="{{$option_value}}" @if($option_value == $delivery->getSetting($setting['field'])) selected @endif>{{$option_name}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                @endif
                                                            </div>
