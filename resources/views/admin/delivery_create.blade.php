                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="free_from" name="free_from" placeholder="" value="{{old('free_from')}}" type="text">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="delivery_payments[]" class="select2 select2-multiple" multiple="multiple" data-placeholder="Choose">
                                                @foreach($all_payments as $p)
                                                    <option value="{{$p->id}}" @if(in_array($p->id, old('delivery_payments', []))) selected @endif>{{$p->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
